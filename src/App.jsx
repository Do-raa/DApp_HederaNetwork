...
function App() {
	...
	const [topictTextSt, setTopicTextSt] = useState("");
	...
	async function topicCreate() {
			...
			setTopicTextSt(`topic id is ${topicID} ✅`);
	...
	async function topicMessage() {
			...
			setTopicMsgTextSt(`your new message is ${topicMessage} ✅`);
